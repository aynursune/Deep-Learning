        ...
        for epoch in range(num_epochs):
            ...
            for i, (inputs, targets) in enumerate(train_loader, 1):
                ...
                if log_nth and i % log_nth == 0:
                    ...
                    print('[Iteration {}/{}] TRAIN loss: {}'.format(i + epoch * iter_per_epoch, iter_per_epoch * num_epochs, train_loss))
            ...
            if log_nth:
                print('[Epoch {}/{}] VAL   acc/loss: {}/{}'.format(epoch + 1, num_epochs, val_acc, val_loss))
